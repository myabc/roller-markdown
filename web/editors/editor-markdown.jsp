...
<script type="text/javascript" src="<s:url value="/roller-ui/authoring/editors/jquery.js"/>"></script>
<script type="text/javascript" src="<s:url value="/roller-ui/authoring/editors/jquery.markitup.js"/>"></script>
<script type="text/javascript" src="<s:url value="/roller-ui/authoring/editors/sets/markdown/set.js"/>"></script>
...
$(document).ready(function()	{
    $('#entry_bean_text').markItUp(myMarkdownSettings);
});
</script>
